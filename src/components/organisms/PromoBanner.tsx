...
export function PromoBanner({ onShop }: PromoBannerProps) {
  return (
    <section className="relative overflow-hidden rounded-card bg-gradient-to-r from-[#97D1CC] to-[#C7D7F0] p-6 shadow-card">
      ...
      <div className="relative space-y-3">
        ...
        <button
          type="button"
          onClick={onShop}
          className="rounded-md bg-white px-5 py-2 text-sm font-bold text-ink shadow-soft transition active:scale-95"
        >
          Shop Now
        </button>
      </div>
