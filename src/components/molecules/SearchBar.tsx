...
interface SearchBarProps {
  placeholder?: string
  onScan?: () => void
  /** Controlled value; when provided with onChange the field becomes controlled. */
  value?: string
  onChange?: (value: string) => void
}

/** Rounded search field with a trailing barcode-scan action. */
export function SearchBar({ placeholder = 'Search products', onScan, value, onChange }: SearchBarProps) {
  return (
